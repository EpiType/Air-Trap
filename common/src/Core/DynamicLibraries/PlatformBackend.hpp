...
class PlatformBackend {
   public:
     ...
     */
    [[nodiscard]]
    static auto open(std::string_view path) noexcept -> std::expected<void*, std::string>;
     ...
     */
    [[nodiscard]]
    static auto close(void* handle) noexcept -> std::expected<void, std::string>;
     ...
     */
    [[nodiscard]]
    static auto getSymbol(void* handle, std::string_view name) noexcept -> std::expected<void*, std::string>;
};
}  // namespace rtp::dl::impl
