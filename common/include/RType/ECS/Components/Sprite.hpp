...
namespace rtp::ecs::components
{
    ...
    struct Sprite {
        ...
        std::uint8_t opacity{255}; /**< Opacity of the sprite (0-255) */
        std::uint8_t red{255};     /**< Red color component */
        std::uint8_t green{255};   /**< Green color component */
        std::uint8_t blue{255};    /**< Blue color component */
    };
} // namespace rtp::ecs::components
