...
#ifndef RTYPE_CLIENT_SETTINGS_SCENE_HPP_
    #define RTYPE_CLIENT_SETTINGS_SCENE_HPP_
...
{
    class SettingsScene : public aer::scenes::IScene
    {
        public:
            SettingsScene(aer::ecs::Registry& uiRegistry,
                          Settings& settings,
...
#endif /* !RTYPE_CLIENT_SETTINGS_SCENE_HPP_ */
