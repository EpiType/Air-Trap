...
#ifndef RTYPE_CLIENT_GAMEPAD_SETTINGS_SCENE_HPP_
    #define RTYPE_CLIENT_GAMEPAD_SETTINGS_SCENE_HPP_
...
{
    class GamepadSettingsScene : public aer::scenes::IScene
    {
        public:
            GamepadSettingsScene(aer::ecs::Registry& uiRegistry,
                                 Settings& settings,
        ...
        private:
            static std::vector<std::string> buildButtonOptions();
...
#endif /* !RTYPE_CLIENT_GAMEPAD_SETTINGS_SCENE_HPP_ */
