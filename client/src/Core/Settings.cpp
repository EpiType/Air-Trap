...
bool Settings::loadFromClientJson(const std::string& filename) {
    ...
    while (std::getline(file, line)) {
        ...
        // Parser les contrôles (key bindings)
        if (inControls) {
