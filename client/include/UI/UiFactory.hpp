...
namespace rtp::client
{
    namespace graphics
    {
        ...
        /**
         * @struct size
         * @brief Represents the size of a
         * UI component.
         */
        struct size {
                float width;
        ...
        /**
         * @class UiFactory
         * @brief Factory class for
         * creating UI components in the ECS registry.
         * 
         *
        ...
        class UiFactory {
            public:
                 ...
                 */
                static ecs::Entity
                    createButton(ecs::Registry &registry,
 ...
 * @param
                 ...
                 * @return The
                 * created entity representing the text.
                 */
                static ecs::Entity createText(
                    ecs::Registry &registry, const position &position,
                    const std::string &content, const std::string &fontPath,
                    unsigned int fontSize, const std::uint8_t zIndex = 0,
 ...
 * @param x
                 ...
                 * slider.
                 * @param minValue Minimum value of
                 * the slider.
                 ...
                 * value of the slider.
                 * @param onChange
                 * Callback function to be called when the slider value
                 * changes.
                 * @return The created entity
                 * representing the slider.
                 */
                static ecs::Entity
                    createSlider(ecs::Registry &registry,
                                 const position &position, const size &size,
 ...
 * @param x
                 ...
                 * * @param onSelect Callback function to be called when an
                 * option is selected.
                 * @return The created
                 * entity representing the dropdown.
                 */
                static ecs::Entity createDropdown(
                    ecs::Registry &registry, const position &position,
                    const size &size, const std::vector<std::string> &options,
 ...
 * @param x
                 ...
                 * @param fontSize
                 * Size of the font.
                 * @param maxLength Maximum
                 * length of the input text.
                 * @param
                 * placeholder Placeholder text when input is empty.
 * @param
                 * onChange Callback function to be called when the text
                 * changes.
                 * @return The created entity
                 * representing the text input.
                 */
                static ecs::Entity createTextInput(
                    ecs::Registry &registry, const position &position,
                    const size &size, const std::string &fontPath,
                    unsigned int fontSize, const int maxLength = 64,
                 ...
                 */
                static ecs::Entity createSpritePreview(ecs::Registry& registry,
