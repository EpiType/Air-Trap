...
#ifndef RTYPE_CLIENT_SCENES_SETTINGSSCENE_HPP_
    #define RTYPE_CLIENT_SCENES_SETTINGSSCENE_HPP_
...
namespace rtp::client {
    namespace scenes {
        /**
         * @class SettingsScene
         * @brief Scene for the settings menu.
         * 
         * This scene allows users to configure various application settings,
         * such as audio levels, graphics options, and key bindings.
         */
        class SettingsScene : public interfaces::IScene
        {
            public:
                /**
                 * @brief Constructor for SettingsScene
...
#endif // RTYPE_CLIENT_SCENES_SETTINGSSCENE_HPP_