...
namespace rtp::client {
    namespace Scenes {
        ...
        /**
         * @class LoginScene
         * @brief Scene for user login.
         * 
         * This scene handles user authentication, including input fields
         * for username and password, and a login button.
         */
        class LoginScene : public interfaces::IScene
        {
            public:
                /**
                 ...
                 */
                LoginScene(ecs::Registry& UiRegistry,
                            Settings& settings,
