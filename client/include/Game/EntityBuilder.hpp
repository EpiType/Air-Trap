...
namespace rtp::client
{
    ...
    static constexpr ParallaxDef kParallaxLvl3_1{ "assets/backgrounds/lvl3/Sky_back_mountain.png", 7.0f, {-18.0f, 0.0f}, 255, 50.0f, 1900.0f, {0.72f, 0.72f}, 1900, 1000, 360.0f };
    static constexpr ParallaxDef kParallaxLvl3_2{ "assets/backgrounds/lvl3/sky_cloud_floor_2.png", 14.0f, {-30.0f, 0.0f}, 255, 90.0f, 1900.0f, {0.72f, 0.72f}, 1900, 1000, 360.0f };
    static constexpr ParallaxDef kParallaxLvl3_3{ "assets/backgrounds/lvl3/sky_cloud_floor.png", 18.0f, {-35.0f, 0.0f}, 255, 100.0f, 1900.0f, {0.72f, 0.72f}, 1900, 1000, 360.0f };
    static constexpr ParallaxDef kParallaxLvl3_4{ "assets/backgrounds/lvl3/Sky_cloud_single.png", 9.0f, {-22.0f, 0.0f}, 255, 65.0f, 1900.0f, {0.72f, 0.72f}, 1900, 1000, 360.0f };
    static constexpr ParallaxDef kParallaxLvl3_5{ "assets/backgrounds/lvl3/sky_clouds.png", 11.0f, {-25.0f, 0.0f}, 255, 75.0f, 1900.0f, {0.72f, 0.72f}, 1900, 1000, 360.0f };
    static constexpr ParallaxDef kParallaxLvl3_6{ "assets/backgrounds/lvl3/Sky_front_cloud.png", 13.0f, {-28.0f, 0.0f}, 255, 85.0f, 1900.0f, {0.72f, 0.72f}, 1900, 1000, 360.0f };
    static constexpr ParallaxDef kParallaxLvl3_7{ "assets/backgrounds/lvl3/sky_front_mountain.png", 16.0f, {-32.0f, 0.0f}, 255, 95.0f, 1900.0f, {0.72f, 0.72f}, 1900, 1000, 360.0f };
    static constexpr ParallaxDef kParallaxLvl3_8{ "assets/backgrounds/lvl3/sky_moon.png", 3.0f, {-10.0f, 0.0f}, 255, 30.0f, 3800.0f, {0.72f, 0.72f}, 3800, 2400, 360.0f };
    static constexpr ParallaxDef kParallaxLvl3_9{ "assets/backgrounds/lvl3/Sky_sky.png", 5.0f, {-15.0f, 0.0f}, 255, 40.0f, 1900.0f, {0.72f, 0.72f}, 1900, 1000, 360.0f };
