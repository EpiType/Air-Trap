...
namespace rtp::client
{
    ...
    struct EntityTemplate {
        ...
        static EntityTemplate makeParallax(const ParallaxDef &p)
        {
            EntityTemplate t;
            t.id = "parallax_layer";
            t.position = {0.0f, p.heightOffset};
            t.rotation = 0.0f;
            t.scale = p.scale;
            ...
            t.sprite.rectLeft = 0;
            t.sprite.rectTop = 0;
            t.sprite.rectWidth = 0;  // 0 = utiliser toute l'image
            t.sprite.rectHeight = 0; // 0 = utiliser toute l'image
            ...
            t.parallax.speed = p.velocitySpeed;
            return t;
        }

        // Data tables - Level 1 Parallax
        static constexpr ParallaxDef kParallaxLvl1_1{
            "assets/backgrounds/lvl1/stars_far.png",
            10.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl1_2{
            "assets/backgrounds/lvl1/stars_near.png",
            20.0f,
            {0.0f, 0.0f},
            255,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl2_1{
            "assets/backgrounds/lvl2/moon_earth.png",
            25.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl2_2{
            "assets/backgrounds/lvl2/moon_back.png",
            12.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl2_3{
            "assets/backgrounds/lvl2/moon_floor.png",
            12.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl2_4{
            "assets/backgrounds/lvl2/moon_front.png",
            10.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl2_5{
            "assets/backgrounds/lvl2/moon_mid.png",
            20.0f,
            {0.0f, 0.0f},
            255,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl2_6{
            "assets/backgrounds/lvl2/moon_sky.png",
            10.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl3_1{
            "assets/backgrounds/lvl3/Sky_sky.png",
            8.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl3_2{
            "assets/backgrounds/lvl3/sky_cloud_floor_2.png",
            22.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl3_3{
            "assets/backgrounds/lvl3/sky_cloud_floor.png",
            25.0f,
            {0.0f, 0.0f},
            255,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl3_4{
            "assets/backgrounds/lvl3/sky_clouds.png",
            15.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl3_5{
            "assets/backgrounds/lvl3/Sky_cloud_single.png",
            12.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl3_6{
            "assets/backgrounds/lvl3/Sky_front_cloud.png",
            12.0f,
            {0.0f, 0.0f},
            201,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl3_7{
            "assets/backgrounds/lvl3/sky_front_mountain.png",
            12.0f,
            {0.0f, 0.0f},
            201,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl3_8{
            "assets/backgrounds/lvl3/sky_moon.png",
            5.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl3_9{
            "assets/backgrounds/lvl3/Sky_back_mountain.png",
            10.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl4_1{
            "assets/backgrounds/lvl4/desert_cloud.png",
            12.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl4_2{
            "assets/backgrounds/lvl4/desert_dunefrontt.png",
            30.0f,
            {0.0f, 0.0f},
            255,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl4_3{
            "assets/backgrounds/lvl4/desert_dunemid.png",
            20.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl4_4{
            "assets/backgrounds/lvl4/desert_moon.png",
            5.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl4_5{
            "assets/backgrounds/lvl4/desert_mountain.png",
            10.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        static constexpr ParallaxDef kParallaxLvl4_6{
            "assets/backgrounds/lvl4/desert_sky.png",
            8.0f,
            {0.0f, 0.0f},
            200,
            0.0f,
        ...
        // Level 1 Parallax
        static EntityTemplate createParallaxLvl1_1()
        {
            return makeParallax(kParallaxLvl1_1);
        }

        static EntityTemplate createParallaxLvl1_2()
        {
